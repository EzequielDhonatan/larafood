                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12 col-lg-12 col-md-12">
                            ...
                            <div class="text-right">
                                ...
                                <a class="btn btn-rounded btn-outline-black" href="{{  route( 'category.create' ) }}">
                                    Novo
                                </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12 col-lg-12 col-md-12">
                            ...
                            <form class="form form-inline" method="POST" action="{{ route( 'category.search' ) }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST" action="{{ route( 'category.destroy', $category->id ) }}">
                                                    ...
                                                    <a style="padding-right: 5px;" class="fas fa-eye" href="{{ route( 'category.show', $category->id ) }}"></a>
